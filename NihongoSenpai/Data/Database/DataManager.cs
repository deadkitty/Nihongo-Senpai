...
namespace NihongoSenpai.Data.Database
{
    public static class DataManager
    {
        ...
        private static void ResetWord(Word w)
        {
            ...
            w.repetitionJapanese = 0;
            w.nextIntervalJapanese = 0;
            ...
            w.repetitionTranslation = 0;
            w.nextIntervalTranslation = 0;
            w.timeStampTransl = 0;
        ...
        public static void InitializeAppData(Lesson selectedLesson)
        {
            ...
            AppData.Words.AddRange(AppData.SelectedLesson.Words);
            AppData.Kanjis.AddRange(AppData.SelectedLesson.Kanjis);
        }
