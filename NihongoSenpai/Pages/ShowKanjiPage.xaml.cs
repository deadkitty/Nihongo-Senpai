...
{
    public partial class ShowKanjiPage : PhoneApplicationPage
    {
        #region Fields
        ...
        private int PrevKanjiIndex
        {
            get
            {
                ...
                return (AppData.Kanjis.Count + currKanjiIndex - 1) % AppData.Kanjis.Count;
            }
        }
        ...
        private int NextKanjiIndex
        {
            get 
            {
                return (currKanjiIndex + 1) % AppData.Kanjis.Count; 
            }
        }
        ...
        public ShowKanjiPage()
        {
            InitializeComponent();

            DetailKanjiItem.canHideText = false;
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            currKanjiIndex = AppData.Kanjis.IndexOf(AppData.SelectedKanji);
