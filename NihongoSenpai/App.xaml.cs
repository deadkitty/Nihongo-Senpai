...
namespace NihongoSenpai
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //DataManager.LoadLessons(Data.Tables.Lesson.EType.vocabulary);

            //List<Lesson> lessons = new List<Lesson>();

            //foreach(Lesson l in AppData.Lessons)
            //{
            //    if(l.name.Contains("Minna"))
            //    {
            //        lessons.Add(l);
            //    }
            //}

            //DataManager.LoadWords(lessons.ToArray());
            ...
            //catch(Exception e)
            //{
            //    Debug.WriteLine(active.ToString());
            //}
