...
namespace NihongoSenpai.Controller
{
    public class JapGerItem : IVocabItem
    {
        ...
        public JapGerItem(Word source)
        {
            ...
            this.repetition = source.repetitionJapanese;
            this.nextInterval = source.nextIntervalJapanese;
        ...
        public void WriteBack()
        {
            ...
            source.repetitionJapanese = repetition;
            source.nextIntervalJapanese = nextInterval;
