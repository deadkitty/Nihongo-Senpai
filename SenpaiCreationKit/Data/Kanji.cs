...
namespace SenpaiCreationKit.Data
{
    ...
    public class Kanji
    {
        ...
        /// <para>id|lessonId|kanji|meaning|onyomi|kunyomi|example|strokeOrder|efactor|repetition|nextInterval|timestamp</para>
        /// <para>Length = 12</para>
        /// </summary>
        ...
        /// <para>Export Pattern:</para>
        /// <para>kanji|meaning|onyomi|kunyomi|example|strokeOrder</para>
        /// <para>Length = 6</para>
        /// </summary>
        ...
        public void Fill(String properties)
        {
            ...
            if(parts.Length == 12)
            {
                ...
                repetition   = Convert.ToInt32 (parts[9]);
                nextInterval = Convert.ToInt32 (parts[10]);
        ...
        public void Fill(Kanji other)
        {
            ...
            nextInterval = other.nextInterval;
